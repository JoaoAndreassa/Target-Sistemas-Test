...
document.getElementById(
  "menor-faturamento"
).textContent = `Menor faturamento: ${resultado.menorFaturamento}`;
document.getElementById(
  "maior-faturamento"
).textContent = `Maior faturamento: ${resultado.maiorFaturamento}`;
document.getElementById(
  "dias-acima-da-media"
).textContent = `Dias com faturamento acima da média: ${resultado.diasAcimaDaMedia}`;
